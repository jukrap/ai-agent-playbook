...
Short skill entrypoints and minimal new record scaffolds do not imply minimal human explanations. README branding, localized navigation, beginner guidance, worked commands, and architecture detail serve readers and should remain useful. See [1.0 changes and previous versions](docs/redesign.md) for the rationale and [Maintenance](docs/maintenance.md) for editing rules.
