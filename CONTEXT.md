...
Skills should be small, composable, and easy to install. Templates can be longer because humans copy and adapt them per project. The project playbook keeps current truth separate from historical worklogs so future agents can recover context without trusting stale plans.
