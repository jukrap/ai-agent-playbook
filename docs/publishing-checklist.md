...
Keep the package name and aapb executable. Use 1.0.0-next.2 during prerelease validation and map Python metadata to 1.0.0.dev2. Do not claim the version is published merely because it exists in source.
