...
- `generic-ui-review`: use when reviewing template-like, card-heavy, pill-heavy, gradient-heavy, glowy, or otherwise generic frontend presentation against product tasks and rendered evidence, then applying the smallest authorized correction through the UI workflow.
