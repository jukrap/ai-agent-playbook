...
- README, root agent rules, `.ai-agent-playbook/` reading order, and current working vocabulary.
...
- `Docs`: source-of-truth files, `.ai-agent-playbook/` state, working vocabulary, map freshness, and latest worklog summary.
