...
function Resolve-Python {
  ...
  if ($py) { return @("py", "-3") }
  throw "Python was not found. Install Python 3.11+ or set AI_PLAYBOOK_PYTHON."
}
...
& $pythonExe @pythonArgs -m ai_playbook_engine --help | Out-Null
...
$output = $sample | & $pythonExe @pythonArgs -m ai_playbook_engine writing-naturalness --json
