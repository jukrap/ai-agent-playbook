...
3. Search relevant entrypoints with `rg`; do not infer stack, routes, tests, or branch policy from habit.
4. State only facts confirmed from fresh output. Mark unresolved items as assumptions or blockers.
