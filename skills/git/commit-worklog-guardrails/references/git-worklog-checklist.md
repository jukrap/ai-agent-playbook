...
If the project uses `.ai-playbook/policy/GIT.md`, keep the short policy and this detailed guide aligned. The playbook file is for standing rules; this reference is for the full procedural checklist.
...
- Use `.ai-playbook/workflows/worklogs/YYYY-MM/` for detailed logs and `.ai-playbook/workflows/worklogs/summaries/YYYY-MM.md` for monthly summaries when the project uses the playbook layout.
