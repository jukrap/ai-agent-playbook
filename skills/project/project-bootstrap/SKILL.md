...
description: Use when starting a new project, inheriting an existing repository, or setting up agent-facing project memory, root agent instructions, and playbook docs.
---
...
4. Adapt root templates from `templates/agents/global` and project memory templates from `templates/project-playbook`.
