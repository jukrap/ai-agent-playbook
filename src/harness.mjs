...
export { buildReferenceAdoptionQueue, checkReferenceAdoptionLedger, initReferenceAdoptionLedger, inventoryReferenceDirectory } from './catalog/reference-adoption.mjs';
