...
Use this file as a portable project-level Git policy. Keep repository-specific branch names, remotes, issue numbers, and protected-branch rules out of this template until a project adapts it.

This is the short root-level policy. It does not replace detailed commit, PR, and worklog guidance such as `../../local-ai/commit-push-worklog.md` when a project needs durable context for future readers.
...
- Keep common abbreviations such as UI, API, PR, HMR, MSW, SDK, JDK, and WebView uppercase when useful.
