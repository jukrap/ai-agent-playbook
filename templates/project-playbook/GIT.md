...
This is the short policy. It does not replace detailed commit, PR, and worklog guidance such as `guides/commit-push-worklog.md` when a project needs durable context for future readers.
