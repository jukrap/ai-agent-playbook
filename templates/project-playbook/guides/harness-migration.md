...
- Do not overwrite `AGENTS.md`, `CLAUDE.md`, `SKILLS.md`, `GIT.md`, or project docs without explicit approval.
...
1. Inspect current root files: `AGENTS.md`, `CLAUDE.md`, `SKILLS.md`, `GIT.md`, `README.md`, and `.gitignore`.
...
- Skill selection rules: reusable skill loading policy goes in `SKILLS.md`.
- Git and PR policy: commit, PR, push, and worklog expectations go in `GIT.md` or `ai-playbook/guides/commit-push-worklog.md`.
...
```text
Read AGENTS.md, SKILLS.md, GIT.md, ai-playbook/README.md, ai-playbook/START_HERE.md,
...
- `AGENTS.md`, `SKILLS.md`, and `GIT.md` either exist or have an explicit reason not to exist.
