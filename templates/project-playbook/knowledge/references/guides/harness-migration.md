...
- Do not overwrite `AGENTS.md`, `CLAUDE.md`, `.ai-playbook/policy/SKILLS.md`, `.ai-playbook/policy/GIT.md`, or project docs without explicit approval.
...
1. Inspect current root files: `AGENTS.md`, `CLAUDE.md`, `README.md`, and `.gitignore`; also inspect `.ai-playbook/policy/SKILLS.md` and `.ai-playbook/policy/GIT.md` when they exist.
...
- Skill selection rules: reusable skill loading policy goes in `.ai-playbook/policy/SKILLS.md`.
- Git and PR policy: commit, PR, push, and worklog expectations go in `.ai-playbook/policy/GIT.md` or `.ai-playbook/knowledge/references/guides/commit-push-worklog.md`.
- Current project truth: active architecture, product constraints, and known commands go in `.ai-playbook/CURRENT.md`.
- Repository maps: where important code lives goes in `.ai-playbook/memory/maps/`.
- Repeatable procedures: setup, release, data import, deployment, debugging, and manual verification flows go in `.ai-playbook/workflows/runbooks/`.
- Decisions: durable architecture or process decisions go in `.ai-playbook/memory/decisions/`.
- Active plans: unfinished implementation plans go in `.ai-playbook/workflows/plans/`.
- Work history: dated reasoning, blockers, verification, and handoffs go in `.ai-playbook/workflows/worklogs/YYYY-MM/`.
...
4. Create a short migration note in `.ai-playbook/workflows/worklogs/YYYY-MM/` describing what moved, what stayed, and what still needs review.
...
```text
Read AGENTS.md, .ai-playbook/policy/SKILLS.md, .ai-playbook/policy/GIT.md, .ai-playbook/README.md, .ai-playbook/START_HERE.md,
.ai-playbook/CURRENT.md, .ai-playbook/questions.md, and .ai-playbook/knowledge/references/guides/harness-migration.md.
...
- `AGENTS.md` points to `.ai-playbook/`, and `.ai-playbook/policy/SKILLS.md` plus `.ai-playbook/policy/GIT.md` either exist or have an explicit reason not to exist.
