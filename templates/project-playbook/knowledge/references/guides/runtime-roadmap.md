...
- Keep detailed history in `workflows/worklogs/` and summarize it when it contains durable facts.
...
- inject compact project-memory context from `START_HERE.md`, `CURRENT.md`, `policy/SKILLS.md`, and `policy/GIT.md` when native context is insufficient;
