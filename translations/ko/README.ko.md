...
| MCP 도구         | AI 앱이 호출할 수 있는 로컬 read-only 도구입니다. context, operator check/search/research, contract, managed state, image diff, AST 검색, TypeScript/JavaScript 분석을 다룹니다. | `src/`             |
