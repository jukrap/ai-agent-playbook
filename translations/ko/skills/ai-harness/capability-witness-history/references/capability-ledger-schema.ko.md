...
- Generated ledger는 `.ai-agent-playbook/runtime/reports/capabilities/` 또는 `.ai-agent-playbook/runtime/indexes/` 아래에 둡니다.
- 검토된 summary나 durable decision만 `.ai-agent-playbook/memory/`로 승격합니다.
