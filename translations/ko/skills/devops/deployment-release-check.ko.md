...
Release confidence가 log, metric, trace, alert, queue, post-deploy monitoring에 달려 있으면 `references/observability-release-loop.md`를 읽습니다.

Release, hotfix, rollback이 operator handoff와 containment path를 필요로 하면 `references/incident-rollback-handoff.md`를 읽습니다.
