...
3. 존재하면 `ai-playbook/START_HERE.md`, `CURRENT.md`, relevant maps, relevant runbooks를 읽습니다.
4. 관련 entrypoints는 `rg`로 찾습니다. stack, route, test, branch policy를 습관으로 추론하지 않습니다.
5. fresh output으로 확인한 사실만 말합니다. unresolved items는 assumptions 또는 blockers로 표시합니다.
