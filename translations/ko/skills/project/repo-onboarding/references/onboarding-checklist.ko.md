...
- README, root agent rules, `.ai-playbook/` reading order, current working vocabulary.
...
- `Docs`: source-of-truth files, `.ai-playbook/` state, working vocabulary, map freshness, latest worklog summary.
