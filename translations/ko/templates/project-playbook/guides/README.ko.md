...
- `pragmatic-fsd.md`: 프로젝트가 증명할 때만 쓰는 FSD-style architecture.
- `legacy-mode.md`: 오래되었거나 coupling이 큰 시스템의 조심스러운 유지보수.

Guide는 current code, user instructions, root agent rules, project configuration을 덮어쓰지 않습니다.
