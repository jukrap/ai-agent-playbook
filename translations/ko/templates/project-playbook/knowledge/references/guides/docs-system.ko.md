...
- `.ai-playbook/policy/SKILLS.md`: 프로젝트 수준 스킬 선택 정책.
- `.ai-playbook/policy/GIT.md`: 짧은 Git, commit, PR, push 정책.
...
- 구조 사실은 `.ai-playbook/memory/maps/`에 둡니다.
- 반복 명령은 `.ai-playbook/workflows/runbooks/`에 둡니다.
- 진행 중 계획은 `.ai-playbook/workflows/plans/`에 둡니다.
- 상세 이력은 `.ai-playbook/workflows/worklogs/`에 둡니다.
